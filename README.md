...
能亲操键，亦善假 AI 之力。或 Rust，或 Go，或 TypeScript，前后端皆涉，桌面应用亦多。
数据库自 MySQL 至 DuckDB 靡不摆弄，框架自 Vue 至 Tauri 皆有交付。不拘工具，唯问产出。
...
- **[tiberius](https://github.com/tiberius-rs/tiberius)** <a href="https://github.com/tiberius-rs/tiberius"><img src="https://img.shields.io/github/stars/tiberius-rs/tiberius?style=social" alt="GitHub stars" height="16"></a> — Rust 的 TDS 7.2+（Microsoft SQL Server）驱动
- **[datafusion-sqlparser-rs](https://github.com/apache/datafusion-sqlparser-rs)** <a href="https://github.com/apache/datafusion-sqlparser-rs"><img src="https://img.shields.io/github/stars/apache/datafusion-sqlparser-rs?style=social" alt="GitHub stars" height="16"></a> — 可扩展的 Rust SQL 词法与语法解析器
